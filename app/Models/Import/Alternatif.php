...
class Alternatif extends Model
{
    ...
    protected $table = 'import_alternatif';
    const tableName = 'import_alternatif';
    const excelFolder = 'assets/import/alternatif';
    ...
    {
        return $this->hasMany(ModelsAlternatif::class, 'import_id', 'id');
    }
    ...
    public static function import(Request $request, Alternatif $model)
    {
        // setup
    ...
    public static function format(Request $request)
    {
        ...
        $title_excel = "Formulir Import Alternatif";
        // Header excel ================================================================================================
        ...
        // header 2 ====================================================================================================
        $row += 1;
        $sheet->mergeCells($col_start . $row . ":" . $col_end . $row)->setCellValue("A$row", "Formulir Import Alternatif");
        ...
        //     $sheet->setCellValue(chr(65 + ++$c) . "$row", $detail->bobot);
    ...
    public static function export(Request $request)
    {
        ...
        $col_start = "A";
        $col_end = chr(64 + count($headers));
        $title_excel = "Export Data Alternatif";
        // Header excel ================================================================================================
        $spreadsheet = new Spreadsheet();
        $sheet = $spreadsheet->getActiveSheet();
        ...
        foreach ($details['body'] as $detail) {
            ...
            $detail = (object)$detail;
            $sheet->setCellValue(chr(65 + $c) . "$row", ($row - 5));
            $sheet->setCellValue(chr(65 + ++$c) . "$row", $detail->nopeserta);
            $sheet->setCellValue(chr(65 + ++$c) . "$row", $detail->nama);
