    ...
    const new_table = table_html.DataTable({
        ...
        },
        {
            ...
            render(data, type, full, meta) {
                return `<a type="button" href="${full.excel_link}" class="btn btn-rounded btn-secondary btn-sm me-1 mt-1" title="Download">
        ...
        ...(can_update || can_delete ? [{
            ...
            name: 'id',
            render(data, type, full, meta) {
                const btn_update = can_update ? `<button type="button" class="btn btn-rounded btn-primary btn-sm me-1 mt-1" title="Ubah Data" onClick="editFunc('${data}')">
                        <i class="fas fa-edit"></i></button>` : '';
                const btn_delete = can_delete ? `<button type="button" class="btn btn-rounded btn-danger btn-sm me-1 mt-1" title="Hapus Data" onClick="deleteFunc('${data}')">
